...
return [
    ...
    'exclude_file_patterns' => [
        '/\.php$/',
        '/mix-manifest\.json$/',
        // exclude www/dist/js/filament using preg_match
        '/\/js\/filament\/.*$/',
        // exclude www/dist/css/filament using preg_match
        '/\/css\/filament\/.*$/',
        // exclude www/dist/css/style.min.css.map using preg_match
     ...
     */
    'after' => [
        'adjust' => 'php artisan export:after',
